...
// Assumption:
// The student submission provides int main() and is a single-file console program.
// db.csv must be supplied through "Data Files for Student".
int main();
...
public:
    ...
    void test_d_errtxt()
    {
        ...
        // Primary check mirrors the Python batch tester: compare normalized stdout.
        ...
        // Optional fallback: accept solutions that write malformed rows to err.txt
        // and then expose them through command d indirectly.
